...
class MeshFromMaps:
    ...
    def __init__(self):
        # with open(os.path.join(os.path.dirname(__file__), '../assets/hres.pkl'), 'r', encoding='latin1') as f:
        # with open(os.path.join(os.path.dirname(__file__), '../assets/hres.pkl'), 'rb', encoding='latin1') as f:
        with open(os.path.join(os.path.dirname(__file__), '../assets/hres.pkl'), 'rb') as f:
            self.hres = pkl.load(f, encoding="latin1")

        # with open(os.path.join(os.path.dirname(__file__), '../assets/neutral_smpl.pkl'), 'r',encoding='latin1') as f:
